  ...
  all_data$CabinPos <- as.factor(all_data$CabinPos)
  ...
  my_tree_five <- rpart(Survived ~ Pclass + Sex + Age + SibSp + Parch + Fare + Embarked + Title + family_size + CabinPos, data = train_new, method="class")
